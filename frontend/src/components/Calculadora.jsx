...
const SureBetCalculator = () => {
  ...
  <Paper elevation={3} sx={{ p: 3 }}>
    ...
    <Typography variant="subtitle1" gutterBottom align="center" color="text.secondary">
      Calcule lucros garantidos com oportunidades de arbitragem
    </Typography>

    <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 3 }}>
      <Tabs value={activeTab} onChange={handleTabChange} centered>
        <Tab label="Mercado de 2 Opções" />
        <Tab label="Mercado de 3 Opções" />
      </Tabs>
    </Box>
    ...
    {activeTab === 0 ? (
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={4}>
          <TextField
            fullWidth
            label="Odd Vitória do Visitante"
            type="number"
    ...
    {advancedMode && (
      <Box sx={{ mt: 3 }}>
        <Typography gutterBottom>Valor Total da Aposta</Typography>
        <Slider
          value={totalStake}
        ...
        {results.error ? (
          ...
          <>
            <Alert severity="success" sx={{ mb: 2 }}>
              <strong>Oportunidade de Arbitragem Encontrada!</strong> - Soma dos inversos: {results.sumInverses.toFixed(4)} (&lt;1)
            </Alert>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="right">Valor Apostado</TableCell>
                    <TableCell align="right">Retorno Potencial</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <Paper elevation={2} sx={{ p: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Typography>Retorno Garantido:</Typography>
                    <Typography>{formatCurrency(results.stakes[0].payout)}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 1 }}>
                    <Typography variant="body1"><strong>Lucro Garantido:</strong></Typography>
    ...
    <Box sx={{ mt: 4, pt: 2, borderTop: 1, borderColor: 'divider' }}>
      <Typography variant="body2" color="text.secondary">
        <strong>Como usar:</strong> Insira as odds de diferentes casas de apostas para todos os resultados possíveis.
        A calculadora determinará se há uma oportunidade de arbitragem e mostrará como distribuir sua aposta.
      </Typography>
    </Box>
  </Paper>
</Container>
